...
report_received_style = get_received_style(report_received_name, received_bg_color)

report_not_received_name = "נתמך לא קיבל/ה"
not_received_bg_color = "E0503D"
report_not_received_style = get_received_style(report_not_received_name, not_received_bg_color)
